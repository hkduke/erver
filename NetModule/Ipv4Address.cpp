...
bool Ipv4Address::operator==(ISocketAddress& a)
{
...
std::shared_ptr<ISocketAddress> Ipv4Address::GetCopy()
{
	return std::shared_ptr<ISocketAddress>(new Ipv4Address(m_addr));
}
