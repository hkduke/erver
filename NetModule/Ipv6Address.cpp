...
bool Ipv6Address::operator==(ISocketAddress& a)
{
...
std::shared_ptr<ISocketAddress> Ipv6Address::GetCopy()
{
	return std::shared_ptr<ISocketAddress>(new Ipv6Address(m_addr));
}
