...
class CGameLogic
{
	//变量定义
private:
	static CT_BYTE						m_cbCardListData[MAX_CARD_TOTAL];//扑克定义
...
public:
	...
	//对比扑克
	CT_BYTE CompareCard(CT_BYTE cbFirstData[], CT_BYTE cbNextData[], CT_BYTE cbCardCount);
	//获取牌型倍数
	CT_BYTE	GetCardMultiple(CT_BYTE cbCardType, CT_BYTE cbCardData[]);
