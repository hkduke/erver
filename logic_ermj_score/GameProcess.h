...
private:
    ...
    //bSendTipData true:给所有人都发  false:只给dwChairID发
    CT_VOID TipPlayerMayBeHuCard_AfterTing(CT_DWORD dwChairID, CT_BYTE cbCardData, CT_BOOL bZiMo, CT_BOOL bFirstOutCard, CT_BOOL bSendTipData = CT_TRUE);
    //听牌后获取能胡的牌剩余张数
...
private:
	...
	CT_DWORD						m_dwTingCardPlayerCnt;					//听牌玩家数
